...
public class ClassModifier {
    ...
    public byte[] modifyUTF8Constant(String oldStr, String newStr){
        ...
        for(int i = 0; i < cpc; i++){
            ...
            if(tag == CONSTANT_Utf8_info){
                ...
                offset += (u1 + u2);
                String str = BytesUtils.bytes2String(classByte, offset, len);
                if(str.equalsIgnoreCase(oldStr)){
                    ...
                    classByte = BytesUtils.bytesReplace(classByte, offset, newStr.length(), strBytes);
                    return classByte;
                }
            }else{
                offset += tag;
    ...
    public int getConstantPoolCount(){
        return BytesUtils.bytes2Int(classByte, CONSTANT_POOL_COUNT_INDEX, u2);
    }
}
